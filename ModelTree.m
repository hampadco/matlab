%%
function [Answer_Train,Answer_Test,Answer2,CTime] = ModelTree(Data)
...
%% train and test
tic
HyperparameterOptimizationOptions.Optimizer = 'gridsearch';
 HyperparameterOptimizationOptions.NumGridDivisions = 15;

tree = fitrtree(Input_Train,Target_Train);
CTime = toc;
...
title(sprintf('Tree ROC Curve (AUC = %.3f)', AUC_all));
grid on;
